...
flags_dir = r"C:\Users\20210666\Desktop\Courses TUe\CurrencyConverter\flags"
...
base_currency_combo = ttk.Combobox(frame, textvariable=base_currency_var, values= list(currencies.keys()), font=("Arial", 12), state="readonly", width=10)
...
target_currency_combo = ttk.Combobox(frame, textvariable=target_currency_var, values=list(currencies.keys()), font=("Arial", 12), state="readonly", width=10)
